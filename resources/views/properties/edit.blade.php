                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                        <div class="sm:col-span-3">
                            <label for="street" class="mb-1 block text-sm font-medium text-slate-700">Street Address</label>
                            <input type="text" id="street" name="street"
                                ...
                                placeholder="e.g., Main Street" value="{{ old("street", $property->street) }}">
                            @error("street")
                        ...
                        <div>
                            ...
                            <input type="text" id="house_number" name="house_number"
                                ...
                                placeholder="123" value="{{ old("house_number", $property->house_number) }}">
                            @error("house_number")
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="city" name="city"
                                ...
                                placeholder="e.g., New York" value="{{ old("city", $property->city) }}">
                            @error("city")
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="state" name="state"
                                ...
                                placeholder="e.g., New York" value="{{ old("state", $property->state) }}">
                            @error("state")
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="postcode" name="postcode"
                                ...
                                placeholder="e.g., 10001" value="{{ old("postcode", $property->postcode) }}">
                            @error("postcode")
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="country" name="country"
                                ...
                                placeholder="e.g., USA" value="{{ old("country", $property->country) }}">
                            @error("country")
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <input type="hidden" id="address" name="address" value="{{ old("address", $property->address) }}">
                </div>

                <!-- Current Location Info -->
                @if($property->latitude && $property->longitude)
                    <div class="rounded-lg border border-blue-200 bg-blue-50 p-4">
                        <h4 class="mb-2 text-sm font-semibold text-slate-700 flex items-center gap-2">
                        ...
                        <div class="text-sm">
                            <div class="font-mono text-xs text-slate-900 mb-2">
                            ...
                            <a href="https://www.openstreetmap.org/?mlat={{ $property->latitude }}&mlon={{ $property->longitude }}&zoom=15" 
                               target="_blank"
                               class="inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-800 underline">
